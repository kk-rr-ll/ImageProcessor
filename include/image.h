...
public:
    ...
    const uint8_t* getPixelWithBeginChannel(int x, int y) const { return &data_[(y * width_ + x) * channels_]; }
    uint8_t* getPixelWithBeginChannel(int x, int y) { return &data_[(y * width_ + x) * channels_]; }
