...
int main() {
    ...
    loadPath = std::string(testDataDir) + "/test_image1.bmp";
    savePath = std::string(testDataDir) + "/resampled_image.bmp";
    ...
    img.resamplingByHeight(newHeight, InterpolationMethod::NEAREST_NEIGHBOR);
